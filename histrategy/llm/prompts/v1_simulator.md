...
9. **差异化叙事（最重要）**: `faction_narratives` 必须为每个活跃势力生成独立的叙事。这是强制性要求，不可省略。每个势力的叙事应从该势力的视角出发，描述其本季度的经历、得失和局势变化。不要复制粘贴——每个叙事应有独特内容，包含该势力特有的具体人物（谋士、将领）和具体事件。叙事使用半文言风格。注意：faction_narratives 对象必须包含所有活跃势力的键，即使某个势力本季度无事，也要从该势力视角描述"按兵不动"的原因。
