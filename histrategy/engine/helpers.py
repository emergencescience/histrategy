...
EARLY_TURNS_SUGGESTIONS = {
        ...
        "cao": {
            1: {
                "zh": [
                    ...
                    "[cao_t1_pacify]【安抚河北】降低冀州税率至20%，安抚新附之民，巩固河北后方",
                    "[cao_t1_farms]【屯田许昌】在许昌周边推行军屯，储备南征粮草",
                    "[cao_t1_envoy]【劝降孙权】遣使赴江东，以朝廷名义封孙权为讨虏将军，试探其意",
                ],
                "en": [
                    "【Southern Campaign】Drill the navy at Xuanwu Lake, prepare to march on Jing Province",
                    "[cao_t1_pacify]【Pacify Hebei】Lower tax rates to appease newly conquered northern provinces",
                    "[cao_t1_farms]【Garrison Farms】Establish military farms near Xuchang to stockpile provisions",
                    "[cao_t1_envoy]【Envoy to Wu】Send an imperial decree to Sun Quan, offering titles to test his loyalty",
                ],
            },
            2: {
                "zh": [
                    "【整军备战】在许昌集结主力，于禁乐进各统一军准备南征",
                    "[cao_t2_divide]【分化诸侯】遣使赴益州刘璋，示以朝廷威德，劝其归附",
                    "[cao_t2_purge]【肃清谍网】命校事府彻查江东细作，清剿内部谍报网",
                    "[cao_t2_literary]【文学兴盛】在邺城举办文学盛会，招揽天下文人以壮声势",
                ],
                "en": [
                    "【Mobilize Forces】Assemble the main army at Xuchang for the southern expedition",
                    "[cao_t2_divide]【Divide the Vassals】Send envoys to Liu Zhang in Yi Province to demand submission",
                    "[cao_t2_purge]【Purge Spies】Order the secret police to root out Wu intelligence networks",
                    "[cao_t2_literary]【Literary Patronage】Host literary gatherings at Ye to attract scholar talent",
                ],
            },
            3: {
                "zh": [
                    "【南征先锋】命曹仁为先锋，率精骑五千先行进驻宛城",
                    "[cao_t3_navy_sprint]【水军提速】加紧玄武池水军训练，限期三月成军",
                    "[cao_t3_subvert]【策反荆州】密遣细作赴襄阳，联络蔡瑁张允以为内应",
                    "[cao_t3_overawe]【威震关中】命夏侯渊巡视长安，安抚凉州诸羌",
                ],
                "en": [
                    "【Vanguard South】Dispatch Cao Ren with 5,000 elite cavalry to Wancheng",
                    "[cao_t3_navy_sprint]【Navy Sprint】Accelerate naval training — deadline three months to readiness",
                    "[cao_t3_subvert]【Subvert Jing】Send covert agents to Xiangyang to recruit Cai Mao as an inside ally",
                    "[cao_t3_overawe]【Overawe the West】Have Xiahou Yuan patrol Chang'an and pacify the Qiang tribes",
                ],
            },
            4: {
                "zh": [
                    "【主力南下】曹操亲率大军二十万从许昌出发，天下震动",
                    "[cao_t4_proclaim]【檄文讨逆】发布讨逆檄文，斥刘备孙权为叛臣，号召天下共讨",
                    "[cao_t4_supply]【后勤保障】命程昱督运粮草，确保大军补给线通畅",
                    "[cao_t4_secure]【安抚朝臣】在出征前安抚汉献帝及朝中大臣，防止后方生变",
                ],
                "en": [
                    "【March South】Cao Cao personally leads 200,000 troops from Xuchang — the realm trembles",
                    "[cao_t4_proclaim]【Proclamation】Issue a denunciation of Liu Bei and Sun Quan as traitors to the Han",
                    "[cao_t4_supply]【Supply Lines】Appoint Cheng Yu to oversee logistics along the march route",
                    "[cao_t4_secure]【Secure the Court】Pacify Emperor Xian and the court ministers before departure",
                ],
            },
        },
        "shu": {
            1: {
                "zh": [
                    ...
                    "[shu_t1_drill]【练兵新野】在新野招募训练新兵，扩充军力以备不时之需",
                    "[shu_t1_befriend]【结好刘表】遣简雍赴襄阳，以宗室之谊请求刘表支援粮草军械",
                    "[shu_t1_watch]【北境设防】命赵云巡视新野北境，设烽火台警戒宛城曹军动向",
                ],
                "en": [
                    "【Longzhong Plan】Consult Zhuge Liang on the Three-Way Division strategy against Cao Cao",
                    "[shu_t1_drill]【Drill at Xinye】Recruit and train new soldiers to strengthen the army",
                    "[shu_t1_befriend]【Befriend Liu Biao】Send Jian Yong to Xiangyang to request supplies as fellow Han kinsmen",
                    "[shu_t1_watch]【Northern Watch】Order Zhao Yun to patrol Xinye's northern border and set up beacon towers",
                ],
            },
            2: {
                "zh": [
                    "【招揽人才】命诸葛亮举荐荆州贤才，徐庶马良等入幕",
                    "[shu_t2_arsenal]【扩充军备】在新野周边招募义勇，打造兵器铠甲",
                    "[shu_t2_diplomacy]【外交孙权】遣诸葛亮携关羽赴江东，试探孙权联刘抗曹之意",
                    "[shu_t2_welfare]【安抚百姓】降低新野税率，开仓赈济流民，收拢民心",
                ],
                "en": [
                    "【Recruit Talent】Have Zhuge Liang recommend Jing Province scholars to join the staff",
                    "[shu_t2_arsenal]【Expand Arsenal】Recruit volunteers around Xinye, forge weapons and armor",
                    "[shu_t2_diplomacy]【Diplomatic Mission】Send Zhuge Liang to Jiangdong to propose an anti-Cao alliance",
                    "[shu_t2_welfare]【Welfare Relief】Lower taxes and open granaries to refugees to win popular support",
                ],
            },
            3: {
                "zh": [
                    "【南迁准备】预判曹操南下在即，与诸葛亮商议撤退襄阳方案",
                    "[shu_t3_ally]【联吴定策】正式遣诸葛亮赴柴桑，向孙权陈述利害，促成孙刘联盟",
                    "[shu_t3_absorb]【收编刘琦】联络江夏公子刘琦，争取收编其麾下水军",
                    "[shu_t3_retreat]【撤离新野】组织新野百姓南迁，避免曹军屠戮",
                ],
                "en": [
                    "【Evacuation Plan】Anticipate Cao Cao's southern march — plan withdrawal to Xiangyang",
                    "[shu_t3_ally]【Forge Alliance】Send Zhuge Liang to Chaisang to convince Sun Quan of the alliance",
                    "[shu_t3_absorb]【Absorb Liu Qi】Contact Prince Liu Qi at Jiangxia to integrate his naval forces",
                    "[shu_t3_retreat]【Civilian Evacuation】Organize the people of Xinye to retreat south ahead of Cao's army",
                ],
            },
            4: {
                "zh": [
                    "【赤壁前夜】与周瑜会师，准备在赤壁迎击曹操水陆大军",
                    "[shu_t4_fire]【火攻筹备】命诸葛亮观察气象，选择火攻最佳时机",
                    "[shu_t4_integrate]【水军整合】将收编的荆州水军与江东水军合并训练",
                    "[shu_t4_scorched]【坚壁清野】在江北实施坚壁清野，断曹军就地补给",
                ],
                "en": [
                    "【Eve of Red Cliffs】Link up with Zhou Yu, prepare to confront Cao Cao at Red Cliffs",
                    "[shu_t4_fire]【Fire Attack】Have Zhuge Liang study the weather for the optimal fire attack window",
                    "[shu_t4_integrate]【Naval Integration】Merge captured Jing naval forces with Wu's fleet for joint training",
                    "[shu_t4_scorched]【Scorched Earth】Deny Cao Cao's army local supplies north of the river",
                ],
            },
        },
        "wu": {
            1: {
                "zh": [
                    ...
                    "[wu_t1_pacify]【稳定山越】派程普鲁肃安抚山越诸部，巩固江东后方",
                    "[wu_t1_scout]【联刘抗曹】遣鲁肃赴新野，以吊刘表之名探刘备虚实，商议联盟",
                    "[wu_t1_develop]【发展江东】降低吴郡会稽税率，鼓励农商，充实府库",
                ],
                "en": [
                    "【Expand Navy】Order Zhou Yu to construct warships at Poyang Lake, grow the fleet to 30,000",
                    "[wu_t1_pacify]【Pacify Shanyue】Send Cheng Pu and Lu Su to settle the Shanyue tribes in the hinterlands",
                    "[wu_t1_scout]【Scout Liu Bei】Dispatch Lu Su to Xinye under the pretext of condolences to assess Liu Bei",
                    "[wu_t1_develop]【Develop Jiangdong】Lower taxes in Wu and Kuaiji to promote commerce and agriculture",
                ],
            },
            2: {
                "zh": [
            ...
            3: {
                "zh": [
                    ...
                    "[wu_t3_ally]【联刘定盟】正式与刘备结盟，约定共击曹操，胜后荆州归刘",
                    "[wu_t3_supply]【粮草囤积】在柴桑芜湖囤积大军粮草，准备长期作战",
                    "[wu_t3_rally]【激励将士】孙权亲临柴桑劳军，斩杀案几以示抗曹决心",
                ],
                "en": [
                    "【Red Cliffs Line】Deploy Zhou Yu and Cheng Pu's main fleet to Red Cliffs",
                    "[wu_t3_ally]【Seal Alliance】Formally ally with Liu Bei — promise Jing Province in exchange for joint victory",
                    "[wu_t3_supply]【Stockpile Supplies】Accumulate grain at Chaisang and Wuhu for a prolonged campaign",
                    "[wu_t3_rally]【Rally Troops】Sun Quan visits Chaisang personally, cuts a table corner to show resolve",
                ],
            },
            4: {
                "zh": [
                    "【火攻曹操】周瑜黄盖定下苦肉计，准备火攻曹操连环战船",
                    "[wu_t4_wind]【东风借箭】与诸葛亮配合，利用东南风实施火攻计划",
                    "[wu_t4_block]【分兵阻击】命吕蒙率偏师阻击曹军可能从陆路南下的援军",
                    "[wu_t4_postwar]【战后布局】预先派遣鲁肃赴南郡，准备赤壁战后抢占荆州要地",
                ],
                "en": [
                    "【Fire Ships】Zhou Yu and Huang Gai prepare the self-sacrifice ruse to ignite Cao's chained fleet",
                    "[wu_t4_wind]【East Wind】Coordinate with Zhuge Liang to exploit the seasonal wind for the fire attack",
                    "[wu_t4_block]【Block Reinforcements】Order Lü Meng to intercept possible overland Cao reinforcements",
                    "[wu_t4_postwar]【Post-Battle Plan】Pre-deploy Lu Su to Nan Commandery to seize Jing after Red Cliffs",
                ],
            },
        },
    },
    "rome-triumvirate": {
        "octavian": {
            1: {
                "zh": [
                    "[octavian_t1_rally]【征召旧部】召回高卢时期的老兵，组建属于你的嫡系军团",
                    "[octavian_t1_senate]【发表演说】前往元老院宣读遗嘱，争取温和派元老的支持",
                    "[octavian_t1_confront]【密会强敌】拜访执政官安东尼，要求其归还恺撒的遗产",
                ],
                "en": [
                    "[octavian_t1_rally]【Rally Veterans】Recall Caesar's Gallic War veterans to form your personal legions",
                    "[octavian_t1_senate]【Senate Speech】Address the Senate, read Caesar's will, and court the moderates",
                    "[octavian_t1_confront]【Confront Antony】Meet with Consul Mark Antony to demand Caesar's inheritance",
                ],
            },
            2: {
                "zh": [
                    "[octavian_t2_raise]【招募军团】在坎帕尼亚招募新兵，扩编至五个军团",
                    "[octavian_t2_court]【拉拢西塞罗】与元老院领袖西塞罗建立政治同盟",
                    "[octavian_t2_opinion]【舆论造势】在罗马广场散发传单，宣扬你是恺撒的合法继承人",
                ],
                "en": [
                    "[octavian_t2_raise]【Raise Legions】Recruit in Campania, expand to five legions",
                    "[octavian_t2_court]【Court Cicero】Build a political alliance with the Senate's leading orator",
                    "[octavian_t2_opinion]【Shape Opinion】Distribute pamphlets in the Forum declaring you Caesar's true heir",
                ],
            },
            3: {
                "zh": [
                    "[octavian_t3_march]【北进高卢】率军团北上，争取山南高卢行省总督支持",
                    "[octavian_t3_seek]【元老院授职】请求元老院授予你代行执政官权力（Imperium）",
                    "[octavian_t3_divide]【离间分化】散布安东尼与埃及不清不楚的传言，削弱其合法性",
                ],
                "en": [
                    "[octavian_t3_march]【March North】Lead legions to Cisalpine Gaul, seek the governor's allegiance",
                    "[octavian_t3_seek]【Seek Imperium】Petition the Senate for pro-praetorian authority",
                    "[octavian_t3_divide]【Divide and Conquer】Spread rumors of Antony's Egyptian entanglements",
                ],
            },
            4: {
                "zh": [
                    "[octavian_t4_mutina]【穆提纳之战】联合元老院军团围攻穆提纳，驱逐安东尼",
                    "[octavian_t4_marchrome]【进军罗马】以胜利者姿态率军南下，要求元老院选举你为执政官",
                    "[octavian_t4_triumvirate]【后三头结盟】在博洛尼亚与安东尼、雷必达会盟，瓜分罗马天下",
                ],
                "en": [
                    "[octavian_t4_mutina]【Mutina Campaign】Besiege Mutina with Senate forces, drive Antony out of Italy",
                    "[octavian_t4_marchrome]【March on Rome】Lead victorious legions south, demand election as consul",
                    "[octavian_t4_triumvirate]【Second Triumvirate】Meet Antony and Lepidus at Bononia — divide the Roman world",
                ],
            },
        },
        "antony": {
            1: {
                "zh": [
                    "[antony_t1_secure]【稳固罗马】作为执政官掌控罗马城，调动恺撒国库充实军备",
                    "[antony_t1_veterans]【安抚军队】赏赐恺撒老兵每人500银币，稳固军心",
                    "[antony_t1_hunt]【西讨庞培】派兵清剿西西里的塞克斯图斯·庞培残余舰队",
                ],
                "en": [
                    "[antony_t1_secure]【Secure Rome】As consul, control the city and tap Caesar's treasury for the army",
                    "[antony_t1_veterans]【Reward Veterans】Grant 500 denarii per soldier to lock in Caesar's veteran loyalty",
                    "[antony_t1_hunt]【Hunt Pompey】Send forces to clear Sextus Pompey's remnants from Sicily",
                ],
            },
            2: {
                "zh": [
                    "[antony_t2_north]【北进高卢】率两个军团北上，收编山南高卢及纳尔榜高卢行省",
                    "[antony_t2_purge]【整顿吏治】更换各行省总督，安插自己的亲信控制税收",
                    "[antony_t2_egypt]【外交埃及】加强与克利奥帕特拉的联系，确保东部粮食供应",
                ],
                "en": [
                    "[antony_t2_north]【Move North】March two legions into Gaul, absorb Cisalpine and Narbonensis provinces",
                    "[antony_t2_purge]【Purge Governors】Replace provincial governors with loyal appointees to control tax revenue",
                    "[antony_t2_egypt]【Egyptian Ties】Strengthen relations with Cleopatra to secure eastern grain shipments",
                ],
            },
            3: {
                "zh": [
                    "[antony_t3_defy]【对抗元老院】宣布元老院为非法，要求屋大维交出非法征募的军团",
                    "[antony_t3_siege]【围攻穆提纳】率军包围穆提纳城，逼迫元老院军投降",
                    "[antony_t3_east]【东方战略】向马其顿方向扩展，建立东方势力范围",
                ],
                "en": [
                    "[antony_t3_defy]【Defy the Senate】Declare the Senate's decrees invalid, demand Octavian disband his legions",
                    "[antony_t3_siege]【Siege Mutina】Encircle Mutina and force the Senate's legions to capitulate",
                    "[antony_t3_east]【Eastern Strategy】Expand influence eastward toward Macedonia",
                ],
            },
            4: {
                "zh": [
                    "[antony_t4_retreat]【战略撤退】若战不利则退入纳尔榜高卢，保存主力",
                    "[antony_t4_talks]【后三头会盟】接受雷必达调解，在博洛尼亚与屋大维谈判分权",
                    "[antony_t4_claim]【分配东方】争取分得东方富庶行省，建立自己的王国",
                ],
                "en": [
                    "[antony_t4_retreat]【Strategic Retreat】If pressed, withdraw to Narbonensis to preserve the army",
                    "[antony_t4_talks]【Triumvirate Talks】Accept Lepidus' mediation, negotiate power-sharing with Octavian at Bononia",
                    "[antony_t4_claim]【Claim the East】Secure the wealthy eastern provinces as your domain",
                ],
            },
        },
        "cleopatra": {
            1: {
                "zh": [
                    "[cleopatra_t1_consolidate]【巩固埃及】巡视亚历山大里亚和昔兰尼加，整饬内政",
                    "[cleopatra_t1_fleet]【扩建海军】在塞浦路斯和亚历山大里亚扩建舰队保护贸易",
                    "[cleopatra_t1_gifts]【联络安东尼】派遣使节携带尼罗河礼物前往罗马会见安东尼",
                ],
                "en": [
                    "[cleopatra_t1_consolidate]【Consolidate Egypt】Tour Alexandria and Cyrenaica, reform domestic administration",
                    "[cleopatra_t1_fleet]【Expand Fleet】Build warships in Cyprus and Alexandria to protect trade routes",
                    "[cleopatra_t1_gifts]【Gifts to Antony】Send emissaries with Nile treasures to meet Mark Antony in Rome",
                ],
            },
            2: {
                "zh": [
                    "[cleopatra_t2_grain]【粮食外交】以埃及谷物为筹码，向饥荒中的罗马城施以恩惠",
                    "[cleopatra_t2_alexandria]【建设亚历山大里亚】投资图书馆和博物馆，打造地中海文化中心",
                    "[cleopatra_t2_cyprus]【塞浦路斯治理】派遣总督治理塞浦路斯，垄断东地中海铜矿贸易",
                ],
                "en": [
                    "[cleopatra_t2_grain]【Grain Diplomacy】Use Egyptian grain as leverage — feed starving Rome, earn its gratitude",
                    "[cleopatra_t2_alexandria]【Build Alexandria】Invest in the Library and Museum, make Alexandria the cultural capital",
                    "[cleopatra_t2_cyprus]【Cyprus Administration】Appoint a governor to Cyprus, monopolize eastern copper trade",
                ],
            },
            3: {
                "zh": [
                    "[cleopatra_t3_back]【支持安东尼】提供战舰和资金支持安东尼的军事行动，换取东地中海霸权",
                    "[cleopatra_t3_south]【南方远征】派遣远征军沿尼罗河南下，探索上埃及金矿",
                    "[cleopatra_t3_balance]【离间分化】在安东尼与屋大维之间保持平衡，确保埃及安全",
                ],
                "en": [
                    "[cleopatra_t3_back]【Back Antony】Supply ships and funds for Antony's campaigns in exchange for eastern hegemony",
                    "[cleopatra_t3_south]【Southern Expedition】Send scouts up the Nile to explore Upper Egyptian gold mines",
                    "[cleopatra_t3_balance]【Balance of Power】Play Antony and Octavian against each other to keep Egypt safe",
                ],
            },
            4: {
                "zh": [
                    "[cleopatra_t4_dominion]【东方王国】与安东尼达成协定，将东地中海划为埃及势力范围",
                    "[cleopatra_t4_navy]【海军称霸】组建东地中海最强大的舰队，控制海上贸易",
                    "[cleopatra_t4_union]【王国联姻】考虑与安东尼建立更紧密的王朝联姻关系",
                ],
                "en": [
                    "[cleopatra_t4_dominion]【Eastern Dominion】Negotiate with Antony to carve out an eastern sphere for Egypt",
                    "[cleopatra_t4_navy]【Naval Supremacy】Build the most powerful fleet in the eastern Mediterranean",
                    "[cleopatra_t4_union]【Dynastic Union】Consider a royal marriage alliance with Mark Antony",
                ],
            },
        },
        "senate": {
            1: {
                "zh": [
                    "[senate_t1_defend]【维护共和】在元老院发表捍卫共和制度的演说，反对军人独裁",
                    "[senate_t1_legions]【收编军团】整合伊利里亚和美索不达米亚的驻军，编入元老院直属军团",
                    "[senate_t1_isolate]【孤立安东尼】动员元老院宣布安东尼为国家公敌（Hostis）",
                ],
                "en": [
                    "[senate_t1_defend]【Defend the Republic】Deliver a speech in the Senate defending the Republic against military tyranny",
                    "[senate_t1_legions]【Consolidate Legions】Integrate the Illyrian and Mesopotamian garrisons under Senate command",
                    "[senate_t1_isolate]【Isolate Antony】Mobilize the Senate to declare Antony a public enemy (Hostis)",
                ],
            },
            2: {
                "zh": [
                    "[senate_t2_court]【拉拢屋大维】承认屋大维为恺撒的合法继承人，利用他对抗安东尼",
                    "[senate_t2_reform]【重建军制】任命元老院派的将领统率各军团，防止军人干政",
                    "[senate_t2_audit]【财政整顿】清查恺撒、安东尼侵占的公款，追回国库资金",
                ],
                "en": [
                    "[senate_t2_court]【Court Octavian】Recognize Octavian as Caesar's legitimate heir to use him against Antony",
                    "[senate_t2_reform]【Military Reform】Appoint senatorial commanders to prevent military interference in politics",
                    "[senate_t2_audit]【Financial Audit】Investigate Caesar and Antony's embezzlement, recover public funds",
                ],
            },
            3: {
                "zh": [
                    "[senate_t3_grant]【授权讨逆】授予屋大维代行执政官权力，命其率军讨伐安东尼",
                    "[senate_t3_east]【巩固东方】派遣使节安抚叙利亚和亚细亚行省，防止东方叛乱",
                    "[senate_t3_greek]【外交希腊】拉拢希腊各城邦，在东西方之间建立缓冲地带",
                ],
                "en": [
                    "[senate_t3_grant]【Grant Imperium】Award Octavian pro-praetorian authority to march against Antony",
                    "[senate_t3_east]【Secure the East】Send envoys to pacify Syria and Asia, prevent eastern rebellion",
                    "[senate_t3_greek]【Greek Diplomacy】Court the Greek city-states as a buffer between east and west",
                ],
            },
            4: {
                "zh": [
                    "[senate_t4_mutina]【穆提纳战役】派遣执政官率元老院军团北上，与屋大维合击安东尼",
                    "[senate_t4_purge]【战后清算】击败安东尼后清算其党羽，恢复元老院的绝对权威",
                    "[senate_t4_game]【三头博弈】警惕屋大维势力膨胀——共和国不能以新暴君取代旧暴君",
                ],
                "en": [
                    "[senate_t4_mutina]【Battle of Mutina】Dispatch consular legions north to join Octavian against Antony",
                    "[senate_t4_purge]【Post-War Purge】After defeating Antony, purge his allies and restore Senate supremacy",
                    "[senate_t4_game]【Three-Way Game】Beware Octavian's growing power — the Republic cannot trade one tyrant for another",
                ],
            },
        },
    },
