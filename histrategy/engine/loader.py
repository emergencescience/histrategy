...
def _default_factions() -> dict[str, FactionState]:
    ...
    return {
        ...
        "liubiao": FactionState(
            id="liubiao", name="刘表军", ruler_id="liubiao",
            capital="xiangyang", territories=["xiangyang", "jiangling", "jiangkou"],
            strength_actual=40000, treasury=10000, food=8000,
            tax_rate=0.3, morale_actual=50, prestige=50,
            relations={"cao": -20, "shu": 40, "wu": -10},
            aggression=0.3, cunning=0.3, caution=0.8,
            diplomacy=0.6, development_focus=0.7, mercy=0.5,
        ),
    }
