...
class GameSessionManager:
    ...
    def __init__(self, data_dir: str | None = None):
        if data_dir is None:
            default = os.environ.get(
                "HISTRATEGY_DATA_DIR", os.path.expanduser("~/.histrategy")
            )
    ...
    def _create_session(
        self, platform: str, chat_id: str, faction_id: str, scenario: str
    ) -> GameSession:
    ...
    def _build_initial_world(self, faction_id: str, scenario: str) -> WorldState:
        """Build a minimal initial WorldState for the given scenario.

        For MVP, uses hardcoded defaults based on the 207 scenario data
        from histrategy-knowledge/.
        """
        # Default territories for 207 scenario
        territories = {
            "xinye": Territory(
                id="xinye", name="新野", owner_id="shu",
                population=30000, development=25, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=6,
                neighbors=["wancheng", "xiangyang"],
            ),
            "wancheng": Territory(
                id="wancheng", name="宛城", owner_id="cao",
                population=50000, development=45, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=7,
                neighbors=["xinye", "xuchang", "luoyang"],
            ),
            "xuchang": Territory(
                id="xuchang", name="许昌", owner_id="cao",
                population=100000, development=70, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=7,
                neighbors=["wancheng", "luoyang", "ye", "xiapi"],
            ),
            "luoyang": Territory(
                id="luoyang", name="洛阳", owner_id="cao",
                population=80000, development=65, terrain_type=TerrainType.PLAINS,
                climate_zone="north", fertility=7,
                neighbors=["wancheng", "xuchang", "ye"],
            ),
            "ye": Territory(
                id="ye", name="邺城", owner_id="cao",
                population=120000, development=75, terrain_type=TerrainType.PLAINS,
                climate_zone="north", fertility=8,
                neighbors=["xuchang", "luoyang", "ji"],
            ),
            "ji": Territory(
                id="ji", name="蓟县", owner_id="cao",
                population=60000, development=40, terrain_type=TerrainType.PLAINS,
                climate_zone="north", fertility=5, horse_resource=True,
                neighbors=["ye"],
            ),
            "xiangyang": Territory(
                id="xiangyang", name="襄阳", owner_id="liubiao",
                population=80000, development=55, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=8, has_river=True,
                neighbors=["xinye", "jiangling", "chaisang"],
            ),
            "jiangling": Territory(
                id="jiangling", name="江陵", owner_id="liubiao",
                population=60000, development=50, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=8, has_river=True,
                neighbors=["xiangyang", "chaisang", "chengdu"],
            ),
            "chengdu": Territory(
                id="chengdu", name="成都", owner_id="liuzhang",
                population=100000, development=60, terrain_type=TerrainType.MOUNTAIN,
                climate_zone="south", fertility=8, has_river=True,
                neighbors=["jiangling", "hanshui"],
            ),
            "hanshui": Territory(
                id="hanshui", name="汉中", owner_id="liuzhang",
                population=40000, development=35, terrain_type=TerrainType.MOUNTAIN,
                climate_zone="central", fertility=5,
                neighbors=["chengdu"],
            ),
            "jianye": Territory(
                id="jianye", name="建业", owner_id="wu",
                population=70000, development=55, terrain_type=TerrainType.PLAINS,
                climate_zone="south", fertility=7, has_river=True, has_coast=True,
                neighbors=["chaisang", "wu"],
            ),
            "chaisang": Territory(
                id="chaisang", name="柴桑", owner_id="wu",
                population=40000, development=40, terrain_type=TerrainType.PLAINS,
                climate_zone="south", fertility=7, has_river=True,
            ...
            "xiapi": Territory(
                ...
                population=50000, development=45, terrain_type=TerrainType.PLAINS,
                climate_zone="central", fertility=7, has_coast=True,
                neighbors=["xuchang"],
            ),
        }

        # Default factions for 207 scenario
        factions = {
            "shu": FactionState(
                id="shu", name="刘备", ruler_id="liubei",
                capital="xinye", territories=["xinye"],
                prestige=35, strength_actual=5000, strength_estimated=5000,
                treasury=3000, food=2000, tax_rate=0.2,
                ...
                diplomacy=0.8, development_focus=0.8, mercy=0.95,
            ),
            "cao": FactionState(
                ...
                treasury=50000, food=30000, tax_rate=0.4,
                morale_actual=80, morale_estimated=80,
                ...
                diplomacy=0.5, development_focus=0.6, mercy=0.2,
            ),
            "wu": FactionState(
                id="wu", name="孙权", ruler_id="sunquan",
                capital="jianye",
                territories=["jianye", "chaisang", "wu"],
                prestige=60, strength_actual=60000, strength_estimated=60000,
                treasury=15000, food=10000, tax_rate=0.3,
                morale_actual=75, morale_estimated=75,
                economy_actual=55, economy_estimated=55,
                relations={"shu": 20, "cao": -30},
                aggression=0.6, cunning=0.6, caution=0.5,
                diplomacy=0.6, development_focus=0.6, mercy=0.5,
            ),
            "liubiao": FactionState(
                id="liubiao", name="刘表", ruler_id="liubiao",
                capital="xiangyang",
                territories=["xiangyang", "jiangling"],
                prestige=50, strength_actual=40000, strength_estimated=40000,
                treasury=10000, food=8000, tax_rate=0.3,
                morale_actual=50, morale_estimated=50,
                economy_actual=50, economy_estimated=50,
                relations={"shu": 40, "cao": -20, "wu": -10},
            ),
            "liuzhang": FactionState(
                id="liuzhang", name="刘璋", ruler_id="liuzhang",
                capital="chengdu",
                territories=["chengdu", "hanshui"],
                prestige=30, strength_actual=50000, strength_estimated=50000,
                treasury=12000, food=15000, tax_rate=0.3,
                morale_actual=55, morale_estimated=55,
                economy_actual=40, economy_estimated=40,
                relations={"shu": 10, "cao": -10, "liubiao": 20},
            ),
        }

        # Default characters for 207 scenario (key figures)
        characters = {
            "liubei": Character(
                id="liubei", name="刘备", alias="玄德",
                faction_id="shu", location="xinye",
            ...
            "caocao": Character(
                ...
                faction_id="cao", location="xuchang",
                leadership=98, might=72, intelligence=93, politics=94, charisma=92,
                skills=["统率", "谋略", "诗文", "屯田"],
                birth=155, death=220,
            ),
            "sunquan": Character(
                id="sunquan", name="孙权", alias="仲谋",
                faction_id="wu", location="jianye",
            ...
            "zhouyu": Character(
                ...
                faction_id="wu", location="chaisang",
        ...
        # Initial army for player faction
        armies = {}
        if faction_id in factions:
            ...
            armies[army_id] = Army(
                ...
                commander_id="",
                units={
                    UnitType.INFANTRY: 3000,
                    UnitType.CAVALRY: 500,
                    UnitType.ARCHER: 1500,
                },
                morale=80,
                training=1.0,
                supply=30,
