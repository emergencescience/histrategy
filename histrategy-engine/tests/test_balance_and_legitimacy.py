...
def test_turn_controller_famine_and_legitimacy():
    ...
    factions = {
        "shu": FactionState(
            ...
            treasury=3000,
            food=1000,  # Not enough to cover winter deficit
            tax_rate=0.2,
            morale_actual=70,
            prestige=35,
            legitimacy=50,
    ...
    armies = {
        "army_shu_1": Army(
            id="army_shu_1", faction_id="shu", location="t1", units={UnitType.INFANTRY: 5000}
        )
    }
...
def test_turn_controller_heavy_tax_legitimacy():
    ...
    factions = {
        "shu": FactionState(
            ...
            strength_actual=5000,
            treasury=3000,
            food=100000,  # Plenty of food, no famine
...
def test_winter_loyalty_and_defection():
    ...
    factions = {
        "shu": FactionState(
            ...
            morale_actual=70,
            prestige=35,
            legitimacy=10,  # Very low legitimacy!
        )
    }
    ...
    world = WorldState(
        year=207,
        season=Season.WINTER,
        turn_number=1,  # WINTER season triggers annual loyalty change
        scenario="207",
        player_faction_id="shu",
        territories={"t1": t1},
